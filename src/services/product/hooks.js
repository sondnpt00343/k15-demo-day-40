 ...
 * 
 * @returns {Object} Object chứa isLoading và products
 *   - isLoading: boolean - đang tải data hay không
 *   - products: Array - danh sách sản phẩm từ Redux store
 * 
 * CÁCH HOẠT ĐỘNG:
...
export function useFetchProducts() {
    ...
    // products sẽ tự động update khi store thay đổi
    ...
    // Trả về loading state và danh sách sản phẩm để component sử dụng
