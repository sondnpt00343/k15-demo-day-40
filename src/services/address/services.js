/**
 * FILE: services/address/services.js
 * 
 * Đây là file định nghĩa các API service functions cho feature address.
...
/**
 * API SERVICE: getProvinces
 * 
 * Function này gọi API để lấy danh sách tỉnh/thành phố từ server.
 * 
 * @returns {Promise<Object>} Promise trả về response từ API
 * 
 * CÁCH HOẠT ĐỘNG:
 * - httpRequest.get("/address/provinces") gọi GET request đến "/address/provinces"
 * - URL đầy đủ sẽ là: baseURL + "/address/provinces" = "https://api01.f8team.dev/api/address/provinces"
...
export async function getProvinces() {
    // Gọi GET request đến endpoint "/address/provinces"
